...
applicationSupportDirectory = os.path.expanduser("~/Library/Application Support/Reveal/")
...
class RevealLoader(object):
    ...
    def localRevealServerBinaryPath(self):
        if "apple-tvos" in self.process.target.triple:
            librariesDirectory = "RevealServer/tvOS"
        else:
            # iOS or watchOS
            librariesDirectory = "RevealServer/iOS"
        
        return os.path.join(applicationSupportDirectory, librariesDirectory, "RevealServer.framework/RevealServer")
